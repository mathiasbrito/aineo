...
- **Released:** `v0.2.0`, with T9 and T13 (PR #37, `main` at `e26838f`); `v0.2.1`, with T15 and T16 (PR #42, `main` at `270743b`); `v0.2.2`, with T11 (PR #48, `main` at `f1285c1`); `v0.2.3`, with T14 (PR #53, `main` at `dcff14f`), all 2026-09-26.
- **Running:** T10, the Report's web links, a small fix (PR #52), in the orchestrator's verification: underlined, ⌘-click and `gx` open them. T20 is planned (PR #54).
- **Next, in two lanes:**
  ...
  - the entry code: T20, `\c` into Claude's prompt in Terminal mode, a small fix (the user, 2026-09-26); then T12, `\tcn` (D16). T19, aineo resuming its own last Claude session per folder (D23), asked for by the user on 2026-09-26, a regular packet since it changes the Claude integration, once Q8 is measured.
...
- MR98, MR101, MR108 and MR111–MR114 of [[Review/2026-09-24 — v1 MVP readings review]], which were not put to the user; MR109 and MR110, which came after the user's answer of 2026-09-26; and T14's readings and limits, MR115–MR125.
